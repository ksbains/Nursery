...
def main():
	...
	print("------------------STORE---------------------------")
	print("Store Number of Lots is: " + getStore(1, "number_of_lots"))
	...
	print("-------------------------ORDERS-------------------------")
	print("Orders StoreId is: " + getOrders(1, "store_id"))
	print("Orders CustomerId is: " + getOrders(1, "cust_id"))
	print("Orders Order Type is: " + getOrders(1, "order_type"))
	print("Orders Payment Status is: " + getOrders(1, "payment_status"))
	print("Orders Price is: " + getOrders(1, "price"))
	print("Orders Delivery Address is: " + getOrders(1, "delivery_address"))
	print("-------------------------ORDER ITEM-------------------------")
	print("OrderItem OrderId is: " + getOrderItem(1, "order_id"))
	print("OrderItem PlantId is: " + getOrderItem(1, "plant_id"))
	print("OrderItem Price is: " + getOrderItem(1, "price"))
	print("OrderItem Rating is: " + getOrderItem(1, "rating"))	
	print("-------------------------EMPLOYEE-------------------------")	
	print("Employee Name is: " + getEmployee(1, "emp_name"))
	print("Employee Store Id is: " + getEmployee(1, "store_id"))
	print("Employee DOJ is: " + getEmployee(1, "doj"))
	print("Employee Phone Number is: " + getEmployee(1, "phone_no"))
	print("Employee Designation is: " + getEmployee(1, "designation"))
	print("Employee Supervisor Id is: " + getEmployee(1, "supervisor_id"))
